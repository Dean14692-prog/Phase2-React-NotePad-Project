...
export default function NoteArea() {
  return (
    <div
      className="d-flex justify-content-center align-items-start vh-100 bg-light"
      style={{ paddingTop: "20vh" }} // push it slightly down from top
    >
      <div className="container" style={{ maxWidth: "800px" }}>
        <h1 className="text-center mb-4 fw-bold">What can I help with?</h1>
